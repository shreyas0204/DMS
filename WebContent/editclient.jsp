									...
									<table id="mainForm1">
										<tbody>
											<input type="hidden" class="form-control" id=""
												name="organizationId" 
												value="<%=rs1.getString("organizationId")%>"/>
											<tr>
												...
												<td><div id="the-basics" class="has-success">
														<input type="text" class="form-control" id=""
															...
															value="<%=rs1.getString("organization_name")%>">
													</div></td>
											</tr>
											...
											<tr>
												...
												<td><div id="the-basics" class="has-success">
														<input type="email" class="form-control"
															...
															value="<%=rs1.getString("relationship_type")%>" name="relationship_type" />
													</div></td>
											...
											<tr>
												...
												<td><div id="the-basics" class="has-success">
														...
														<input type="text" required="required" id="payer_type"
															name="Name" pattern="[a-zA-Z][a-zA-Z0-9\s]*"
